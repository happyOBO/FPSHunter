...
void AFPSHunterCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AFPSHunterCharacter::OnResetVR);
	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AFPSHunterProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void AFPSHunterCharacter::OnResetVR()
{
...
//void AFPSHunterCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
